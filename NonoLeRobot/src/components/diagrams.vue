...
<script>
import { GojsDiagram } from 'gojs-vue'
...
export default {
  ...
  data() {
    return {
      nodeDataArray: [], // vos données de nœuds ici
      linkDataArray: [], // vos données de liens ici
      diagram: null // pour stocker la référence au diagramme
    }
  },
  mounted() {
    this.initDiagram()
  ...
  methods: {
    initDiagram() {
      ...
      this.diagram = myDiagram // stocker la référence au diagramme
    },
    ...
    importDiagram() {
      ...
      fileInput.onchange = (event) => {
        ...
        reader.onload = (event) => {
          ...
          this.diagram.model = go.Model.fromJson(data) // utilisez this.diagram
        }
